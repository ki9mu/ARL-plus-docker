...
A: 随便开启一个域名的扫描，看`DB-GET-Subdomains: 123`和`DB-Update-Subdomains: 123`两个属性是否比较大，第一个一般是3位数，如果个位数或者十几秒就结束了，说明数据库连接失败了。
...
# 交流
![image](https://user-images.githubusercontent.com/47977616/167830347-59a5a3bc-10ec-430f-9d15-1d8157f0c77c.png)
